...
st.set_page_config(page_title= "BizCardX",
                   ...
                   menu_items={'About':"This dashboard app is created by Bhargavi Ingale!"}
                   )
